const validateCreateTag = (req, res, next) => {
  ...
  if (peso_matching === undefined || typeof peso_matching !== 'number' || Number.isNaN(peso_matching) || peso_matching < 0 || peso_matching > 1) {
    errors.push('peso_matching debe ser un número entre 0 y 1.');
  }
