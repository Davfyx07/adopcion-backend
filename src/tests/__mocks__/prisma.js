...
const prisma = {
    ...
    mascotaFoto: createModelMock(),
    mascotaTag: createModelMock(),
    opcionTag: createModelMock(),
    tag: createModelMock(),
    terminoAceptado: createModelMock(),
    logAuditoria: createModelMock(),
    recuperacionPassword: createModelMock(),
    blacklistToken: createModelMock(),
    match: createModelMock(),
    notificacion: createModelMock(),
    historialWhatsappAlbergue: createModelMock(),
    adoptanteTag: createModelMock(),
